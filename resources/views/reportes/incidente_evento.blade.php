        ...
        <div class="bs-docs-section">
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    {!! Form::open(array('url' => 'reportes/incidenteEventoProcesado', 'method' => 'POST', 'class' => 'form-horizontal')) !!}
                    <table class="table table-striped table-hover ">
                        <tbody>
                        <tr>
                            <td>
                                <div class="form-group">
                                    <label for="tipo_incidente_id" class="col-md-5 control-label">Tipo Incidente </label>
